...
thingArn = ''
thingId = ''
thingName = 'cs437_Thing-'+''.join([random.choice(string.ascii_letters + string.digits) for n in range(15)])
...
def add_thing_to_group():
	...
	response = thingClient.add_thing_to_thing_group(
        ...
        thingGroupArn='arn:aws:iot:us-east-2:796973478303:thinggroup/Many_iot_thing_group',
        thingName=thingName,
        thingArn=thingArn,
